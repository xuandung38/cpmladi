(function($, undefined) {
    ...
    $.fn.ui_video_player = function() {
        var video_modal = $('<div class="video-modal modal" role="dialog"><div class="dialog container"><a class="close" data-close="modal" aria-hidden="true">Ă—</a><div class="video-player"></div></div></div>');
        var toggle = this;
